...
namespace WorldsApart.Code.Graphics
{
    class AnimatedSprite : SpriteIMG
    {
        ...
        public override void Draw(SpriteBatch theSpriteBatch) //This draws the stuffs. And it's more complex than just the Sprite version.
        {
            ...
            //And then we draw! 
            if (auraTexture != null) theSpriteBatch.Draw(auraTexture, sPosition, auraTexture.Bounds, Color.White, 0, new Vector2(auraTexture.Width / 2, auraTexture.Height / 2), 1, SpriteEffects.None, depth);
            if (texture != null) theSpriteBatch.Draw(texture, sPosition, crop, color, rotation, origin, scale, spriteEffects, depth);
